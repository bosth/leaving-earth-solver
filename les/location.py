...
connect_locations("Vfb", "ipt", 1, 3)
connect_locations("Vo", "ipt", 3, 1)
connect_locations("Vo", "V", 0)
connect_locations("C", "ipt", 5, 2)
connect_locations("Eo", "Ec", 3, 0)
connect_locations("Ec", "Eo", 3, 0)
connect_locations("Ec", "Mc", 0, 3)
connect_locations("Mc", "Ec", 0, 3)
connect_locations("Mc", "Mo", 3, 0)
connect_locations("Mo", "Mc", 3, 0)
connect_locations("C", "opt", 3, 1)
connect_locations("Vo", "opt", 9, 1)
